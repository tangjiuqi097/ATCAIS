...
class SelNet(nn.Module):
    def __init__(self):
        ...
        self.conv1=nn.Conv2d(in_channels=512,out_channels=256,kernel_size=1,bias=False)

        self.inplanes = 256
        self.layer1=self._make_layer(Bottleneck,64,3)

        self.conv2 = nn.Conv2d(in_channels=256, out_channels=64, kernel_size=1, bias=False)
