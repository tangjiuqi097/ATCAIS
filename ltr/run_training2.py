...
def main():
    ...
    parser.add_argument('--train_module',default='siam_sel', type=str, help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', default='default3_2', type=str, help='Name of the train settings file.')
