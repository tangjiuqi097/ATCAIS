...
def main():
    ...
    parser.add_argument('--tracker_name',default='atom_test', type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param',default='default', type=str, help='Name of parameter file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset', type=str, default='vot', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    parser.add_argument('--sequence', type=str, default='robot_human_corridor_noocc_3_A', help='Sequence number or name.')
